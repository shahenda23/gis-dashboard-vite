...
import { getDashboardById, saveDashboardRecord } from '../../../services/dashboardService'
...
export const useBuilderStore = create<BuilderStore>((set, get) => ({
  ...
  saveDashboard: async () => {
    ...
    const { error } = await saveDashboardRecord(payload)
  ...
  loadDashboard: async (id: string) => {
    set({ isLoading: true })
    const { data, error } = await getDashboardById(id)
